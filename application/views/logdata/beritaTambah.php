        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="user" method="post" action="<?php echo base_url(); ?>logdata/berita/tambah_aksi" enctype="multipart/form-data">
                        <div class="form-group">
                            <label><span style="color: black;">ID</span> <span style="color: red">*</span></label>
                            <input type="text" name="id" class="form-control" value="<?php echo $max_id_berita; ?>" readonly required>
                        </div>
                        <div class="form-group">
